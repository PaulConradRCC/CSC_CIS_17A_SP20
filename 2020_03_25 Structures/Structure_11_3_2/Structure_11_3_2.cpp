// demonstrate initialization of structures and accessing members
...
int main(int argc, char** argv) {
    ...
    cout << right << setw(FIELD_WIDTH) << student1.studentName << endl;
    cout << left << setw(LABEL_WIDTH) << "Student Year: ";
    cout << right << setw(FIELD_WIDTH) << student1.yearInSchool << endl;
    cout << left << setw(LABEL_WIDTH) << "Student GPA: ";
    cout << right << setw(FIELD_WIDTH) << student1.studentGPA << endl;
