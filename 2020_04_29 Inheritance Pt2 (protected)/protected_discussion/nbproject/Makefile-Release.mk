...
${OBJECTDIR}/inherit_one.o: inherit_one.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/inherit_one.o inherit_one.cpp

${OBJECTDIR}/inherit_three.o: inherit_three.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/inherit_three.o inherit_three.cpp

${OBJECTDIR}/inherit_two.o: inherit_two.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/inherit_two.o inherit_two.cpp

${OBJECTDIR}/protected_discussion.o: protected_discussion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/protected_discussion.o protected_discussion.cpp

${OBJECTDIR}/sample_base.o: sample_base.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sample_base.o sample_base.cpp
