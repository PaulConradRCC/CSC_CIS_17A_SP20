...
${OBJECTDIR}/MyArrayClass.o: MyArrayClass.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyArrayClass.o MyArrayClass.cpp

${OBJECTDIR}/template_class_demo.o: template_class_demo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/template_class_demo.o template_class_demo.cpp
