...
${OBJECTDIR}/Dog.o: Dog.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Dog.o Dog.cpp

${OBJECTDIR}/Pet.o: Pet.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Pet.o Pet.cpp

${OBJECTDIR}/Vaccination.o: Vaccination.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Vaccination.o Vaccination.cpp

${OBJECTDIR}/animals_inheritance_demo.o: animals_inheritance_demo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/animals_inheritance_demo.o animals_inheritance_demo.cpp
